...
export class Main extends Component {
	...
	render() {
		...
		const viewAll =
			results && results.length !== quests.length ? (
				<p className="page-title view-all" role="button" onClick={this.clearResults}>
					View All Quests
				</p>
			) : null;
		...
		return (
			<main className="Main">
				...
				<div className="main-header">
					...
					<div className="controls">
						...
						<form className="search-bar" onSubmit={this.handleSubmit}>
							<input className="search-input" placeholder="Search your quests..." onChange={this.handleChange} />
				...
				<NavLink to="/new-quest" className="add-quest-btn" type="button">
